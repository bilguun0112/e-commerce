...
const products = [
    ...
    {
        title: 'Speaker',
        img: 'https://www.808audio.com/images/common/SP888/SP888_4_1.png',
        items: [
            {
                device: 'Speaker',
    ...
    {
        title: 'Laptops',
        img: 'https://m.media-amazon.com/images/I/31YH5wvKCfL._SS400_.jpg',
        items: [
            {
                device: 'Laptop & pc',
                itemName: 'Macbook',
            ...
            {
                device: 'Laptop & pc',
                itemName: 'Lenovo IdeaPad Gaming 3',
                id: "12",
    ...
    {
        title: 'Game Console',
        img: 'https://i.ebayimg.com/images/g/RVAAAOSwuONisEjV/s-l400.png',
        items: [
            {
                device: 'Game console',
                itemName: 'Xbox',
